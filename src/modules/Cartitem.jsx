	...
	<li className="cart__item">
		...
		<div className="cart-item__info">
			...
			<div className="cart-item__quantity">
				<button className="cart-item__item__quantity-button cart-item__item__quantity-button_minus"></button>
				<input className="cart-item__quantity-input" type="number" value={1} />
				<button className="cart-item__item__quantity-button cart-item__item__quantity-button_plus"></button>
			</div>
