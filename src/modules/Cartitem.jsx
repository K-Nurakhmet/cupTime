		...
		<li className="cart__item">
			...
			<div className="cart-item__info">
				...
				<div className="cart-item__quantity">
					<button
						className="cart-item__item__quantity-button cart-item__item__quantity-button_minus"
						onClick={handleDecrease}></button>
					<input className="cart-item__quantity-input" type="number" value={data.quantity} readOnly />
					<button
						className="cart-item__item__quantity-button cart-item__item__quantity-button_plus"
